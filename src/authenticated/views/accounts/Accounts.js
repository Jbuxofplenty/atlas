    ...
    return (
      <section className={`${s.root} mb-4`}>
        ...
        <TabContent activeTab={this.state.activeTab}>
          ...
          <TabPane tabId="7">
            <div>
              <h4>File Type <span className="fw-semi-bold">Accounts</span></h4>
              <Row className="icon-list">
              ...
              <h4>Form Control <span className="fw-semi-bold">Accounts</span></h4>
              <Row className="icon-list">
                <Col className="icon-list-item" lg={3} md={4} xs={12}><a
                  href="../icon/check-square"
                ><i className="fa fa-check-square" />
              ...
              <h4>Currency <span className="fw-semi-bold">Accounts</span></h4>
              <Row className="icon-list">
                <Col className="icon-list-item" lg={3} md={4} xs={12}><a href="../icon/btc"><i
                  className="fa fa-bitcoin"
                /> bitcoin <span
              ...
              <h4>Video Player <span className="fw-semi-bold">Accounts</span></h4>
              <Row className="icon-list">
              ...
              <h4>Medical <span className="fw-semi-bold">Accounts</span></h4>
              <Row className="icon-list">
