export const keys = {
  "3MonthAverageTradingVolume": ["Average Trading Volume", "3 Month", "shares"],
  "5DayPriceReturnDaily": ["Price Return Daily", "5 Day", "%"],
  "10DayAverageTradingVolume": ["Average Trading Volume", "10 Day", "shares"],
  ...
  "bookValuePerShareAnnual": ["Book Value Per Share", "Annual", "$/share"],
  ...
  "cashFlowPerShareAnnual": ["Cash Flow Per Share", "Annual", "$/share"],
  "cashFlowPerShareTTM": ["Cash Flow Per Share", "TTM", "$/share"],
  "cashPerSharePerShareAnnual": ["Cash Per Share Per Share", "Annual", ""],
  "cashPerSharePerShareQuarterly": [
    "Cash Per Share Per Share",
    "Quarterly",
    ""
  ],
  ...
  "epsBasicExclExtraItemsAnnual": [
    "EPS Basic (excludes extra)",
    "Annual",
    "$/share"
  ],
  "epsBasicExclExtraItemsTTM": ["EPS Basic (excludes extra)", "TTM", "$/share"],
  "epsExclExtraItemsAnnual": ["EPS (excludes extra)", "Annual", "$/share"],
  "epsExclExtraItemsTTM": ["EPS (excludes extra)", "TTM", "$/share"],
  ...
  "epsInclExtraItemsAnnual": ["EPS (includes extra)", "Annual", "$/share"],
  "epsInclExtraItemsTTM": ["EPS (includes extra)", "TTM", "$/share"],
  "epsNormalizedAnnual": [
  ...
  "freeCashFlowAnnual": ["Free Cash Flow", "Annual", "$M"],
  "freeCashFlowPerShareTTM": ["Free Cash Flow Per Share", "TTM", ""],
  "freeCashFlowTTM": ["Free Cash Flow", "TTM", "$M"],
  ...
  "netDebtAnnual": ["Net Debt", "Annual", "$M"],
  "netDebtInterim": ["Net Debt", "Annual", "$M"],
  ...
  "netProfitMargin5Y": ["Net Profit Margin", "5 Year", "$M"],
  "netProfitMarginAnnual": ["Net Profit Margin", "Annual", "$M"],
  "netProfitMarginTTM": ["Net Profit Margin", "TTM", "$M"],
  "operatingMargin5Y": ["Operating Margin", "5 Year", "$M"],
  "operatingMarginAnnual": ["Operating Margin", "Annual", "$M"],
  "operatingMarginTTM": ["Operating Margin", "TTM", "$M"],
  ...
  "peExclExtraAnnual": [
    "Price to Earnings Ratio (excludes extra)",
    "Annual",
    ""
  ],
  "peExclExtraHighTTM": [
  ...
  "peExclExtraTTM": ["Price to Earnings Ratio (excludes extra)", "TTM", ""],
  "peExclLowTTM": ["Pe Excl Low", "TTM", ""],
  "peInclExtraTTM": ["Pe Incl Extra", "TTM", ""],
  "peNormalizedAnnual": [
    "Price to Earnings Ration (normalized)",
    "d Annual",
    ""
  ],
  "pfcfShareAnnual": ["Price to Free Cash Flow Ratio", "Annual", ""],
  "pfcfShareTTM": ["Price to Free Cash Flow Ratio", "TTM", ""],
